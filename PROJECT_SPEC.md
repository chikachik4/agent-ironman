...
- **VPC 2 (On-prem):** 10.1.0.0/16 (k8s) -> **Tailscale Sidecar** 기반 메시 VPN 연결.
- **VPC 3 (Hub):** 10.2.0.0/16 (Management Hub) -> ECS Fargate, Redis, OpenSearch.

## 3. Technology Stack (Actual)
- **Compute:** AWS ECS Fargate
- **Agent Framework:** **Strands SDK**
- **AI/LLM:** AWS Bedrock (Claude 3.5 Sonnet/Haiku)
- **Message Broker:** Amazon ElastiCache Redis (Async Event/Pub-Sub)
...
4. **Analyst Agent:** 수집 데이터 + OpenSearch 과거 사례 기반 RAG 분석 리포트 생성.
